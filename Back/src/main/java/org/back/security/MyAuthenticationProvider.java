package org.back.security;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import org.back.security.entities.User;
import org.back.security.entities.UserRepository;
import org.back.security.entities.UserService;
...
//        System.out.println(password);
        ...
        if (user!=null)       //return new UsernamePasswordAuthenticationToken(username,password,new ArrayList<>());
        {
            ...
            String[] roles = user.getRol().split("_");
            List<GrantedAuthority> grantedAuthorities = new ArrayList<>();
